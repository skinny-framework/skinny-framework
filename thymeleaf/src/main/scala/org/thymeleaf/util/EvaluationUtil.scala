...
object EvaluationUtil {
  ...
  def evaluateAsIterable(value: AnyRef): JList[AnyRef] = {
    ...
    value match {
      ...
      case jiter: JIterable[_] => jiter.asScala.foreach { obj => result.add(obj.asInstanceOf[AnyRef]) }
      case jmap: JMap[_, _] => jmap.entrySet.asScala.map { e => result.add(toMapEntry(e.getKey, e.getValue)) }
      case array if array.getClass.isArray => array match {
        case a: Array[Byte] => a.foreach { obj => result.add(java.lang.Byte.valueOf(obj)) }
        case a: Array[Short] => a.foreach { obj => result.add(java.lang.Short.valueOf(obj)) }
        case a: Array[Int] => a.foreach { obj => result.add(java.lang.Integer.valueOf(obj)) }
        case a: Array[Long] => a.foreach { obj => result.add(java.lang.Long.valueOf(obj)) }
        case a: Array[Float] => a.foreach { obj => result.add(java.lang.Float.valueOf(obj)) }
        case a: Array[Double] => a.foreach { obj => result.add(java.lang.Double.valueOf(obj)) }
        case a: Array[Boolean] => a.foreach { obj => result.add(java.lang.Boolean.valueOf(obj)) }
        case a: Array[Char] => a.foreach { obj => result.add(java.lang.Character.valueOf(obj)) }
  ...
  def evaluateAsArray(value: AnyRef): Array[AnyRef] = {
    ...
    value match {
      // just added scala.Iterable support
      case iter: Iterable[_] => iter.foreach { obj => result.add(obj.asInstanceOf[AnyRef]) }
      case jiter: JIterable[_] => jiter.asScala.foreach { obj => result.add(obj.asInstanceOf[AnyRef]) }
      case jmap: JMap[_, _] => jmap.entrySet.asScala.foreach { obj => result.add(obj) }
