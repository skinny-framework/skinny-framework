...
class FileUploadTestHelpersTest extends ScalatraFunSuite {
  ...
  val files = Map(
    "textFile" -> new File("scalatra/src/test/resources/org/scalatra/servlet/lorem_ipsum.txt"),
    "binaryFile" -> new File("scalatra/src/test/resources/org/scalatra/servlet/smiley.png")
  )
