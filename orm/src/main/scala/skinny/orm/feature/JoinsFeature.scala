...
trait JoinsFeature[Entity]
   ...
   * @return self
   */
  def joins[Id](associations: Association[_]*): JoinsFeature[Entity] with FinderFeatureWithId[Id, Entity] with QueryingFeatureWithId[Id, Entity] = {
    val _self = this
    ...
    new JoinsFeature[Entity] with FinderFeatureWithId[Id, Entity] with QueryingFeatureWithId[Id, Entity] {
