...
/**
  ...
  */
trait DynamicTableNameFeature[Entity] extends DynamicTableNameFeatureWithId[Long, Entity] {
  self: SkinnyMapperBase[Entity] with IdFeature[Long] =>
...
trait DynamicTableNameFeatureWithId[Id, Entity] { self: SkinnyMapperBase[Entity] with IdFeature[Id] =>
  ...
  def withTableName(
    ...
    new SkinnyMapperBase[Entity] with IdFeature[Id] with DynamicTableNameFeatureWithId[Id, Entity]
    with FinderFeatureWithId[Id, Entity] with QueryingFeatureWithId[Id, Entity] {
