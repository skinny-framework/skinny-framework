...
trait AssociationsFeature[Entity]
  ...
  /**
    ...
    */
  def createJoinDefinition(joinType: JoinType,
                           left: (AssociationsFeature[_], Alias[_]),
                           right: (AssociationsFeature[_], Alias[_]),
                           on: SQLSyntax): JoinDefinition[Entity] = {
  ...
  def joinWithDefaults(right: AssociationsFeature[_],
                       on: (Alias[Entity], Alias[Any]) => SQLSyntax): JoinDefinition[Entity] = {
    innerJoinWithDefaults(right, on)
  }
  def joinWithDefaults[Left](left: AssociationsFeature[Left],
                             right: AssociationsFeature[_],
                             on: (Alias[Left], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
  ...
  def innerJoinWithDefaults(right: AssociationsFeature[_],
                            on: (Alias[Entity], Alias[Any]) => SQLSyntax): JoinDefinition[Entity] = {
    createJoinDefinition(InnerJoin,
                         this  -> this.defaultAlias,
                         right -> right.defaultAlias,
                         on.apply(this.defaultAlias, right.defaultAlias.asInstanceOf[Alias[Any]]))
  }
  def innerJoinWithDefaults[Left](left: AssociationsFeature[Left],
                                  right: AssociationsFeature[_],
                                  on: (Alias[Left], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
    createJoinDefinition(InnerJoin,
  ...
  def join(right: (AssociationsFeature[_], Alias[_]),
           on: (Alias[Entity], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
    innerJoin(right, on)
  }
  def join[Left](left: (AssociationsFeature[Left], Alias[Left]),
                 right: (AssociationsFeature[_], Alias[_]),
                 on: (Alias[Left], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
    innerJoin(left, right, on)
  }
  def innerJoin(right: (AssociationsFeature[_], Alias[_]),
                on: (Alias[Entity], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
    createJoinDefinition(InnerJoin, this -> this.defaultAlias, right, on.apply(this.defaultAlias, right._2))
  }
  def innerJoin[Left](left: (AssociationsFeature[Left], Alias[Left]),
                      right: (AssociationsFeature[_], Alias[_]),
                      on: (Alias[Left], Alias[_]) => SQLSyntax): JoinDefinition[Entity] = {
  ...
  def leftJoinWithDefaults(right: AssociationsFeature[_],
                           on: (Alias[Entity], Alias[Any]) => SQLSyntax): JoinDefinition[_] = {
    createJoinDefinition(LeftOuterJoin,
                         this  -> this.defaultAlias,
                         right -> right.defaultAlias,
                         on.apply(this.defaultAlias, right.defaultAlias.asInstanceOf[Alias[Any]]))
  }
  def leftJoinWithDefaults(left: AssociationsFeature[_],
                           right: AssociationsFeature[_],
                           on: (Alias[_], Alias[_]) => SQLSyntax): JoinDefinition[_] = {
    createJoinDefinition(LeftOuterJoin,
                         left  -> left.defaultAlias,
                         right -> right.defaultAlias,
                         on.apply(left.defaultAlias, right.defaultAlias))
  ...
  def leftJoin(right: (AssociationsFeature[_], Alias[_]),
               on: (Alias[Entity], Alias[_]) => SQLSyntax): JoinDefinition[_] = {
    createJoinDefinition(LeftOuterJoin, this -> this.defaultAlias, right, on.apply(this.defaultAlias, right._2))
  }
  def leftJoin(left: (AssociationsFeature[_], Alias[_]),
               right: (AssociationsFeature[_], Alias[_]),
               on: (Alias[_], Alias[_]) => SQLSyntax): JoinDefinition[_] = {
  ...
  def belongsTo[A](right: AssociationsWithIdFeature[_, A],
  ...
  def belongsToWithJoinCondition[A](right: AssociationsWithIdFeature[_, A],
                                    on: SQLSyntax,
                                    merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
    ...
    new BelongsToAssociation[Entity](
      this,
      unshiftJoinDefinition(joinDef, right.defaultJoinDefinitions.filter(_.enabledEvenIfAssociated)),
      extractor
    )
  }

  def belongsToWithFk[A](right: AssociationsWithIdFeature[_, A],
                         fk: String,
                         merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
  ...
  def belongsToWithFkAndJoinCondition[A](right: AssociationsFeature[A],
                                         fk: String,
                                         on: SQLSyntax,
                                         merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
    val joinDef   = leftJoinWithDefaults(right, on)
  ...
  def belongsToWithAlias[A](right: (AssociationsWithIdFeature[_, A], Alias[A]),
                            merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
  ...
  def belongsToWithAliasAndFk[A](right: (AssociationsWithIdFeature[_, A], Alias[A]),
                                 fk: String,
                                 merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
    belongsToWithAliasAndFkAndJoinCondition(
      right,
      fk,
      sqls.eq(this.defaultAlias.field(fk), right._2.field(right._1.primaryKeyFieldName)),
      merge
    )
  }

  def belongsToWithAliasAndFkAndJoinCondition[A](right: (AssociationsFeature[A], Alias[A]),
                                                 fk: String,
                                                 on: SQLSyntax,
                                                 merge: (Entity, Option[A]) => Entity): BelongsToAssociation[Entity] = {
    ...
    new BelongsToAssociation[Entity](
      this,
      unshiftJoinDefinition(joinDef, right._1.defaultJoinDefinitions.filter(_.enabledEvenIfAssociated)),
      extractor
    )
  }
  ...
  def hasOneWithJoinCondition[A](right: AssociationsFeature[A],
                                 on: SQLSyntax,
  ...
  def hasOneWithFk[A](right: AssociationsFeature[A],
                      fk: String,
                      merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    hasOneWithFkAndJoinCondition(
      right,
      fk,
      sqls.eq(this.defaultAlias.field(this.primaryKeyFieldName), right.defaultAlias.field(fk)),
      merge
    )
  }

  def hasOneWithFkAndJoinCondition[A](right: AssociationsFeature[A],
                                      fk: String,
                                      on: SQLSyntax,
                                      merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    val joinDef   = leftJoinWithDefaults(right, on)
  ...
  def hasOneWithAlias[A](right: (AssociationsFeature[A], Alias[A]),
                         merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    hasOneWithAliasAndFk(right, toDefaultForeignKeyName[Entity](this), merge)
  }

  def hasOneWithAliasAndJoinCondition[A](right: (AssociationsFeature[A], Alias[A]),
                                         on: SQLSyntax,
                                         merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    hasOneWithAliasAndFkAndJoinCondition(right, toDefaultForeignKeyName[Entity](this), on, merge)
  }

  def hasOneWithAliasAndFk[A](right: (AssociationsFeature[A], Alias[A]),
                              fk: String,
                              merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    hasOneWithAliasAndFkAndJoinCondition(right,
                                         fk,
                                         sqls.eq(this.defaultAlias.field(this.primaryKeyFieldName), right._2.field(fk)),
                                         merge)
  }

  def hasOneWithAliasAndFkAndJoinCondition[A](right: (AssociationsFeature[A], Alias[A]),
                                              fk: String,
                                              on: SQLSyntax,
                                              merge: (Entity, Option[A]) => Entity): HasOneAssociation[Entity] = {
    val joinDef   = createJoinDefinition(LeftOuterJoin, this -> this.defaultAlias, right, on)
  ...
  def extractWithAssociations(
    ...
    if (enabledJoinDefinitions.isEmpty) {
      ...
      val oneExtractedSql: OneToXSQL[Entity, NoExtractor, Entity] = sql.one(
        rs =>
      ...
      if (enabledOneToManyExtractors.size == 1) {
        ...
        val sql: OneToManySQL[Entity, Entity, HasExtractor, Entity] = oneExtractedSql
          .toMany { rs =>
        ...
        val sql: OneToManies3SQL[Entity, _, _, _, HasExtractor, Entity] = oneExtractedSql
          ...
          .map {
            /*case*/
            (one, m1, m2, m3) =>
              ex3.merge(ex2.merge(ex1.merge(one, m1.toIndexedSeq), m2.toIndexedSeq), m3.toIndexedSeq)
          }
        sql

      } else if (enabledOneToManyExtractors.size == 4) {
        // one-to-manies 4
        val Seq(ex1: HasManyExtractor[Entity],
                ex2: HasManyExtractor[Entity],
                ex3: HasManyExtractor[Entity],
                ex4: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
        val sql: OneToManies4SQL[Entity, _, _, _, _, HasExtractor, Entity] = oneExtractedSql
          ...
          .map {
            /*case*/
            (one, m1, m2, m3, m4) =>
              ex4.merge(ex3.merge(ex2.merge(ex1.merge(one, m1.toIndexedSeq), m2.toIndexedSeq), m3.toIndexedSeq),
                        m4.toIndexedSeq)
          }
        sql
        ...
        val Seq(ex1: HasManyExtractor[Entity],
                ...
                ex5: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
        ...
        val Seq(ex1: HasManyExtractor[Entity],
                ...
                ex6: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
        val sql: OneToManies6SQL[Entity, _, _, _, _, _, _, HasExtractor, Entity] = oneExtractedSql
          ...
          .map {
            ...
            (one, m1, m2, m3, m4, m5, m6) =>
              ex6.merge(
                ex5.merge(ex4.merge(ex3.merge(ex2.merge(ex1.merge(one, m1.toIndexedSeq), m2.toIndexedSeq),
                                              m3.toIndexedSeq),
                                    m4.toIndexedSeq),
                          m5.toIndexedSeq),
                m6.toIndexedSeq
        ...
        val Seq(ex1: HasManyExtractor[Entity],
                ...
                ex7: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
        ...
        val Seq(ex1: HasManyExtractor[Entity],
                ...
                ex8: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
        ...
        val Seq(ex1: HasManyExtractor[Entity],
                ...
                ex9: HasManyExtractor[Entity]) = enabledOneToManyExtractors.toSeq
  ...
  def extractBelongsTo[That](
    ...
    BelongsToExtractor[Entity](mapper,
                               fk,
                               alias,
